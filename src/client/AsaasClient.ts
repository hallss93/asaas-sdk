...
import { CreditBureauService } from '../services/credit-bureau.service.js';
...
import { SubAccountService } from '../services/sub-account.service.js';
...
export class AsaasClient {
  ...
  readonly creditBureau: CreditBureauService;
  ...
  readonly statement: StatementService;
  readonly subAccounts: SubAccountService;
  ...
  constructor(config?: AsaasClientConfig) {
    ...
    this.creditBureau = new CreditBureauService(this.http);
    ...
    this.invoices = new InvoiceService(this.http);
    ...
    this.statement = new StatementService(this.http);
    this.subAccounts = new SubAccountService(this.http);
